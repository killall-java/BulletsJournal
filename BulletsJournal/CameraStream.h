...
public:
	...
	int stop(LONG &nPort);
	int start(void(CALLBACK *realDataCallBack_V30)(LONG lPlayHandle, DWORD dwDataType, BYTE *pBuffer, DWORD dwBufSize, void* pUser), LONG &nPort, HWND hPlayWnd, char* sDeviceAddress);                  //显示图像
